...
export class ProductListComponent implements OnInit {
  ...
  handleListProduct() {
    ...
    // check if we have different category than preivous
    // Note: Angular will reuse if it is currently being viewed
  ...
  handleSearchProducts() {
    ...
    console.log(
      `keyWord=${this.previousKeyword}, thePageNumber=${this.thePageNumber}`
    );
