...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `mattstore`;

CREATE SCHEMA `mattstore`;
USE `mattstore` ;

-- -----------------------------------------------------
-- Table `full-stack-ecommerce`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mattstore`.`product_category` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mattstore`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
